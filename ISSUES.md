...
| 2026-08-07 | (install) | gap | egao1980/cl-stack | [#165](https://github.com/egao1980/cl-stack/issues/165) | `ensure-system-dependencies` misses OCI `tomlet` for unpublished local SUT — fixed in cl-repository (`:ql` SAT drop) + demos drop `("tomlet" :ql)` |
