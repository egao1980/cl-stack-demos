(defsystem "cl-stack-demos"
  ...
  :depends-on ("alexandria"
               ...
               "websocket-driver"
               "hunchentoot")
  :properties (:cl-repo (:ci (:sources (("babel" :ql) ("trivial-features" :ql) ("usocket" :ql) ("dbd-sqlite3" :ql) ("cl-dbi" :ql) ("jose" :ql) ("ironclad" :ql) ("websocket-driver" :ql) ("clack" :ql) ("hunchentoot" :ql) ("log4cl" :ql)))))
  :serial t
  :pathname "src"
