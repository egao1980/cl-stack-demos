...
| `websockets-echo` | [python-websockets/websockets](https://github.com/python-websockets/websockets) `example/sync/{echo,client}.py` | echo server + client round-trip | BSD-3-Clause | `ws-protocol` |
